...
$sql = "SELECT oilId, aload, dMat, dLoad, dPlant, pLoad, nMat, nLoad, nPlant FROM oilorders";
    ...
    "<td>" . $row['nLoad'] . "</td>" .
    "<td>" . $row['nPlant'] . "</td>" .
    "<td><a href='lab1oc.php?oilId=" . $row['oilId'] . "'>Delete</a></td>" . 
    "<td><a href='lab1od.php?oilId=" . $row['oilId'] . "'>Update</a></td>";
    echo "</tr>";
}
echo("</table>");
print("<a href='lab1oa.php'>Add Order</a>");
echo("</fieldset>");
print("<br/>");
?>
<body>
