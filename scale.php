...
<head>
    ...
    <title>Earle Daily Orders</title>
...
$sql = "SELECT CustId, workd, Cust, JobInfo, Forman, Phone, Material, MixCode, Tonnage, safe, tonsOut, Time, Trucks, Plant FROM dayorders";
    ...
    "<td>" . $row['Trucks'] . "</td>" .
    "<td>" . $row['Plant'] . "</td>" .
    "<td><a href='scale1c.php?CustId=" . $row['CustId'] . "'>Delete</a></td>" . 
    "<td><a href='scale1d.php?CustId=" . $row['CustId'] . "'>Update</a></td>";
    echo "</tr>";
}
echo("</table>");
print("<a href='scale1a.php'>Add Order</a>");
echo("</fieldset>");
print("<br/>");
$sql = "SELECT custId, workd, cust, jobInfo, forman, phone, material, mixCode, tonnage, Safe, TonsOut, time, trucks, plant FROM nightorders";
    ...
    "<td>" . $row['trucks'] . "</td>" .
    "<td>" . $row['plant'] . "</td>" .
    "<td><a href='scale1cc.php?custId=" . $row['custId'] . "'>Delete</a></td>" . 
    "<td><a href='scale1dd.php?custId=" . $row['custId'] . "'>Update</a></td>";
    echo "</tr>";
}
echo("</table>");
print("<a href='scale1aa.php'>Add Order</a>");
echo("</fieldset>");
print("<br/>");
$sql = "SELECT pureId, workd, pure, job, psample, facility, estload, truck, trurou, stime, acc, notes FROM pureorders";
    ...
    "<td>" . $row['acc'] . "</td>" .
    "<td>" . $row['notes'] . "</td>" .
    "<td><a href='scale1pc.php?pureId=" . $row['pureId'] . "'>Delete</a></td>" . 
    "<td><a href='scale1pd.php?pureId=" . $row['pureId'] . "'>Update</a></td>";
    echo "</tr>";
}
echo("</table>");
print("<a href='scale1pa.php'>Add Order</a>");
echo("</fieldset>");
print("<br/>");
$sql = "SELECT truckId, tCust, jInfo, jContact, tTruck, notes FROM truckorders";
    ...
    "<td>" . $row['tTruck'] . "</td>" .
    "<td>" . $row['notes'] . "</td>" .
    "<td><a href='scale1tc.php?truckId=" . $row['truckId'] . "'>Delete</a></td>" . 
    "<td><a href='scale1td.php?truckId=" . $row['truckId'] . "'>Update</a></td>";
    echo "</tr>";
}
echo("</table>");
print("<a href='scale1ta.php'>Add Order</a>");
echo("</fieldset>");
print("<br/>");
$sql = "SELECT oilId, aload, dMat, dLoad, dPlant, pLoad, nMat, nLoad, nPlant FROM oilorders";
    ...
    echo("<table>");
    echo("<tr><th>First Day Load</th><th>Material</th><th># Of Loads</th><th>Plant</th><th>First Night Load</th><th>Material</th><th># Of Loads</th><th>Plant</th><th>Delete</th><th>Update</th></tr>");
    $row = mysqli_fetch_array($result);
    while($row = mysqli_fetch_array($result)){
    echo "<tr>";
    ...
    "<td>" . $row['nLoad'] . "</td>" .
    "<td>" . $row['nPlant'] . "</td>" .
    "<td><a href='scale1oc.php?oilId=" . $row['oilId'] . "'>Delete</a></td>" . 
    "<td><a href='scale1od.php?oilId=" . $row['oilId'] . "'>Update</a></td>";
    echo "</tr>";
}
echo("</table>");
print("<a href='scale1oa.php'>Add Order</a>");
echo("</fieldset>");
print("<br/>");
?>
<body>
